...
/**
 * Repository interface for PersonTree (Closure Table) queries. This provides efficient
 * ancestor/descendant traversal using the closure table pattern.
 */
public interface PersonTreeRepository {
  ...
  /**
   * Delete all tree relationships for regeneration after relationship changes. Should only be used
   * in special scenarios (usually for testing/maintenance).
   */
  void deleteAll();
}
