...
public class Relationship {
  ...
  private Relationship(
      Long id, Long fromPersonId, Long toPersonId, RelationshipType type, LocalDateTime createdAt) {
  ...
  public static Relationship create(Long fromPersonId, Long toPersonId, RelationshipType type) {

    return new Relationship(null, fromPersonId, toPersonId, type, null);
  }
